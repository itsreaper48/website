		...
		<main class="row">
			...
			<section class="col left">
				...
				<div class="social-links">
					<a
						href="https://www.facebook.com/profile.php?id=100084882249955&mibextid=gik2fB">
						<img class="icon"
						src="${pageContext.request.contextPath}/Resources/image/facebook.png"
						alt="facebook">
					</a> <a
						href="https://www.instagram.com/prithivirajsah1?igsh=YWtncHBibzU4bml5">
						<img class="icon"
						src="${pageContext.request.contextPath}/Resources/image/instagram.png"
						alt="instagram">
					</a> <a
						href="https://www.linkedin.com/in/prithivirajsah-bb4314297?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
						<img class="icon"
						src="${pageContext.request.contextPath}/Resources/image/linkdein.png"
						alt="linkdein">
					</a>
				</div>
				<!--Social Media Ends-->
